...
/// <summary>
/// 为JS验证方法提供获取双字节长度.getDcLength()属性
/// </summary>  
...
String.prototype.isNull = function(){ 
    return this.toString().trim().length == 0 ? true : false;
}        
/// <summary>
/// 判断输入的字符是否为整数
/// </summary>   
...
/// 时间加减
/// </summary>
/// <param name="interval">必选项。字符串表达式，表示要添加的时间间隔。有关数值，请参阅“设置”部分。</param>
/// <param name="number">时间加减的值</param>
/// 设置:
/// y 	年
/// q 	季度
/// m 	月
...
/// 时间比较
/// </summary>
/// <param name="interval">必选项。字符串表达式，表示要添加的时间间隔。有关数值，请参阅“设置”部分
/// <param name="objDate2">第二时间</param>
...
/// 根据传入前缀生成随机字符串
/// </summary>
/// <param name="str">字符前缀</param>
function unikey(str){
	return[str,Math.random(),new Date().getMilliseconds()].join("").split(".").join("");
}
/// <summary>
/// html解码
/// </summary>
/// <param name="strHtml">html数据</param>
function htmlDecode(strHtml) {
	return strHtml&&strHtml.replace?(strHtml.replace(/&lt;/gi,"<").replace(/&gt;/gi,">").replace(/&amp;/gi,"&").replace(/&quot;/gi,"\"")):strHtml;
}
/// <summary>
/// html编码
/// </summary>
...
function htmlEncode(strHtml) {
	return strHtml&&strHtml.replace?(strHtml.replace(/&/g,"&amp;").replace(/\"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")):strHtml;
}
/// <summary>
/// URI编码
/// </summary>
/// <param name="strURI">URI数据</param>
function encodeURI(strURI) {
	return strURI&&strURI.replace?strURI.replace(/%/ig,"%25").replace(/\+/ig,"%2B").replace(/&/ig,"%26").replace(/#/ig,"%23"):strURI;
}
/// <summary>
/// URI解码
/// </summary>
...
function decodeURI(strURI) {
	return decodeURIComponent(strURI||"");
}
/// <summary>
/// 判断函数是否存在
/// </summary>
